...
apt-get install -y --no-install-recommends libbullet-dev protobuf-compiler libignition-math2-dev libignition-transport-dev libqwt-dev sdformat-sdf qt5-default

# libtinyxml2-2v5 libtinyxml2-dev

echo "start to build gazebo"

# build and install gazebo
hg clone https://bitbucket.org/osrf/gazebo /opt/gazebo_vr/gazebo
cd /opt/gazebo_vr/gazebo && hg up gazebo7
